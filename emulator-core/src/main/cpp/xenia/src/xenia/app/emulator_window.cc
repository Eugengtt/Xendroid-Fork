...
DEFINE_string(
    ...
    "Display");
DEFINE_string(
    postprocess_scaling_and_sharpening, "bilinear",
...
DEFINE_double(
    ...
    "Display");
DEFINE_uint32(
    postprocess_ffx_fsr_max_upsampling_passes, 1,
    "Maximum number of upsampling passes performed in AMD FidelityFX Super Resolution 1.0 (FSR).",
    "Display");
DEFINE_double(
    postprocess_ffx_fsr_sharpness_reduction,
    xe::ui::Presenter::GuestOutputPaintConfig::kFsrSharpnessReductionDefault,
    "Sharpness reduction for AMD FidelityFX Super Resolution 1.0 (FSR).",
    "Display");
DEFINE_bool(
    postprocess_dither, false,
    "Dither the final image output from the internal precision to 8 bits per channel.",
    "Display");
