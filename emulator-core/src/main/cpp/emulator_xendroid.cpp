...
static void j_set_framerate_limit(JNIEnv* env, jobject thiz, jint value) {
    cvars::framerate_limit = static_cast<uint32_t>(value < 0 ? 0 : value);
}

static jint j_get_framerate_limit(JNIEnv* env, jobject thiz) {
    return static_cast<jint>(cvars::framerate_limit);
}
...
int register_xendroid_Emulator(JNIEnv* env){
    ...
    static const JNINativeMethod methods[] = {
            ...
            // FPS LIMIT
            ,{"set_framerate_limit", "(I)V", (void *) j_set_framerate_limit}
            ,{"get_framerate_limit", "()I", (void *) j_get_framerate_limit}
